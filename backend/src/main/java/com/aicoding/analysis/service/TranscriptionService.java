...
import com.aicoding.analysis.config.AsrProperties;
...
public class TranscriptionService {
    ...
    private String transcribe(MultipartFile file, AsrProperties.ProviderConfig providerConfig, String providerName) {
        ...
        try {
            ...
            JsonNode jsonNode = objectMapper.readTree(Objects.requireNonNull(response));
    ...
    private String transcribeAuto(MultipartFile file) {
        ...
        throw new IllegalStateException("No ASR provider configured. Set Whisper or Challenger API settings in backend/.env.local.");
    }
